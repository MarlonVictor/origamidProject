...
/***/ "./js/modules/accordionAnimation.js":
/*!******************************************!*\
  !*** ./js/modules/accordionAnimation.js ***!
  \******************************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ initOperationTime)\n/* harmony export */ });\nfunction initOperationTime() {\n  var operation = document.querySelector('[data-week]');\n  var weekDays = operation.dataset.week.split(',').map(Number);\n  var weekSchedule = operation.dataset.schedule.split(',').map(Number);\n  var date = new Date();\n  var dayNow = date.getDay();\n  var timeNow = date.getHours();\n  var openWeek = weekDays.indexOf(dayNow) !== -1;\n  var openHours = timeNow >= weekSchedule[0] && timeNow < weekSchedule[1];\n  openWeek && openHours ? operation.classList.add('open') : operation.classList.remove('open');\n}\n\n//# sourceURL=webpack://animais-fantasticos/./js/modules/operationTime.js?");
